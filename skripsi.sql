...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 14, 2021 at 12:17 PM
...
--
ALTER TABLE `detail_menu`
  MODIFY `id_detail_menu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=305;
--
...
--
ALTER TABLE `tbl_poli_faskes`
  MODIFY `id_poli_faskes` int(11) NOT NULL AUTO_INCREMENT;
--
